...
public class ArticleEditController {
	...
	public String draft(
		...
		try {
			article = articleService.updateArticle(form, errors, Post.Status.DRAFT, authorizedUser);
		}
	...
	public String publish(
		...
		Article article = null;
		try {
			article = articleService.updateArticle(form, errors, Post.Status.PUBLISHED, authorizedUser);
		}
		catch (BindException e) {
			if (errors.hasErrors()) {
				logger.debug("Errors: {}", errors);
